...
class IBug2Controller:
    ...
    def stateMachine(self,RRT,odometry):   
        ...
        if self.state == "FORWARD": 
            ...
            print self.last_range<self.last_last_range

            if self.last_range<self.last_last_range and self.last_range<=self.current_range and self.current_UWB_range<self.previous_hit_point and \
        ...
        self.last_last_range = deepcopy(self.last_range)
